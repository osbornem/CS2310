...
public class Board {
	...
	/**
	 * Replace board cell with letter selected
	 */
	...
	/**
	 * Reverse board cell to original state
	 */
	...
	/**
	 * Returns the letter of the integer location
	 */
	...
	/**
	 * Method checks that the cell player chooses is in the board
	 */
	...
	/**
	 * Method checks surrounding cells have letters present in them
	 */
